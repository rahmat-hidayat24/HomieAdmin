                        ...
                        this.state.screen == 'Edit Hunian' ? <View>
                            ...
                            <View style={{ flexDirection: 'row', borderTopColor: '#eee', borderTopWidth: 2, alignItems: 'center' }}>
                                ...
                                <View style={{ flexDirection: 'column', width: '60%', padding: 5 }}>
                                    ...
                                    <Text style={{ color: '#63707e' }}>: {!this.state.infoSewa.harga_hunian_day || this.state.infoSewa.harga_hunian_day == 0 ? 'Harga Harian Tidak Tersedia' : `${Server.FormatCurrency(this.state.infoSewa.harga_hunian_day)} / Hari`}</Text>
                                    <Text style={{ color: '#63707e' }}>: {!this.state.infoSewa.harga_hunian_week || this.state.infoSewa.harga_hunian_week == 0 ? 'Harga Mingguan Tidak Tersedia' : `${Server.FormatCurrency(this.state.infoSewa.harga_hunian_week)} / Minggu`}</Text>
                                    <Text style={{ color: '#63707e' }}>: {!this.state.infoSewa.harga_hunian_month || this.state.infoSewa.harga_hunian_month == 0 ? 'Harga Bulanan Tidak Tersedia' : `${Server.FormatCurrency(this.state.infoSewa.harga_hunian_month)} / Bulan`}</Text>
                                    <Text style={{ color: '#63707e' }}>: {!this.state.infoSewa.harga_hunian_year || this.state.infoSewa.harga_hunian_year == 0 ? 'Harga Tahunan Tidak Tersedia' : `${Server.FormatCurrency(this.state.infoSewa.harga_hunian_year)} / Tahun`}</Text>
                    ...
                    <View>
                        {
                            this.state.listFasilitas.map((item, index) => (
                                <View key={index}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, borderBottomColor: '#f2f6f5', borderBottomWidth: 1 }}>
                                        <View style={{ width: '50%' }}>
                                            <Text style={{ color: '#63707e', marginRight: 10 }}>{item}</Text>
                                        </View>
                                        <View>
